...
export const provinces: Province[] = [
  ...
  { code: 'GT-PE', countryCode: 'GT', name: 'Petén' },
  { code: 'GT-QZ', countryCode: 'GT', name: 'Quetzaltenango' },
  { code: 'GT-QC', countryCode: 'GT', name: 'Quiché' },
  { code: 'GT-RE', countryCode: 'GT', name: 'Retalhuleu' },
  { code: 'GT-SA', countryCode: 'GT', name: 'Sacatepéquez' },
  { code: 'GT-SM', countryCode: 'GT', name: 'San Marcos' },
  { code: 'GT-SR', countryCode: 'GT', name: 'Santa Rosa' },
  { code: 'GT-SO', countryCode: 'GT', name: 'Sololá' },
  { code: 'GT-SU', countryCode: 'GT', name: 'Suchitepéquez' },
  { code: 'GT-TO', countryCode: 'GT', name: 'Totonicapán' },
